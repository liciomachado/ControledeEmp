...
<%
	...
	List<NotaFiscal> nfList = notaDao.getMinhasNotasProtocolar(usuario.getIdUsuario());
	pageContext.setAttribute("notasList", nfList);
%>
        ...
        <div class="col-md-12">
            <form class="form-group needs-validation justify-content-center" method="post" action="../protocolaItens" novalidate>
                <table class="table table-hover">
                    ...
                    <tbody>
                		<c:forEach var="nota" items="${notasList}">
                   			<tr>
